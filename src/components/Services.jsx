...
function Services() {
  return (
    ...
    >
      ...
      <div className="absolute bottom-0 right-1 md:-right-1/4 w-1/2 h-1/2 bg-cyab-400 dark:bg-cyan-500 rounded-full blur-3xl opacity-20 "></div>
      ...
      <div className="md:text-center mb-8">
        ...
        >
          ...
          <p className="text-justify md:text-center sm:text-lg">
            ...
            solutions that increase visibility, generate qualified leads, and
      ...
      <div className="flex flex-col md:flex-row md:justify-between items-center gap-8">
        <motion.div
          ...
          transition={{ duration: 0.7 }}
          viewport={{ once: true, amount: 0.3 }}
          className="w-[100%] md:w-[50%] md:text-left mt-4 mb-8 md:mb-0"
        >
        ...
        >
          ...
          <div className="dark:bg-gray-800 w-[100%]  md:w-[45%] p-6 rounded-lg shadow-lg min-h-[250px] border border-cyan-700 ">
            ...
            <p className="text-base">
              ...
              reflect your brand and convert visitors into customers.`.slice(
                0,
                60
              )}
              ...
