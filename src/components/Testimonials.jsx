      ...
      >
        <SwiperSlide>
          <div className="md:96 bg-gray-800 border p-4 rounded-md border-cyan-800">
            ...
            <div>
              <p>
                “The team truly understood our brand and delivered a campaign
                that doubled our traffic. Highly recommended!”
              </p>
              <div className="flex justify-between items-center mt-4 ">
                <div className="flex space-x-2 ">
                  <span className="bg-cyan-700 p-2 hover:bg-cyan-800 cursor-pointer rounded-md border border-cyan-500">
        ...
        {/* Add more SwiperSlides here */}
           ...
           <button className="custom-prev absolute left-2 top-1/2 -translate-y-1/2 bg-cyan-800 border border-cyan-400 text-white p-2 rounded-full shadow">
        <ChevronLeft/>
      </button>
      <button className="custom-next absolute right-2 top-1/2 -translate-y-1/2 bg-cyan-800  border border-cyan-400 text-white p-2 rounded-full shadow">
        <ChevronRight />
      </button>
        </div>
