...
function Featers() {
 ...
 {cards.map((num, index) => (
        ...
        {/* <div className="w-full md:w-72 bg-linear-to-r hover:from-cyan-700 cursor-pointer hover:to-cyan-900 transition-colors duration-300 from-cyan-900 to-cyan-700 border-cyan-500/70 border flex justify-start items-center gap-4 p-4 bg-gray- rounded-md">
          <div className="">
            <span className="bg-cyan-700 p-2 border rounded-md border-cyan-500 inline-flex items-center justify-center">
              <Sparkles className="w-6 h-6 " />
            </span>
        ...
        <div className="w-full md:w-72 bg-linear-to-r hover:from-cyan-700 cursor-pointer hover:to-cyan-900 transition-colors duration-300 from-cyan-900 to-cyan-700 border-cyan-500/70 border flex justify-start items-center gap-4 p-4 bg-gray- rounded-md">
          ...
          <div className="flex flex-col border-l pl-3 border-cyan-500">
            <span className="text-3xl font-bold">{count}</span>
            <span className="text-lg">Compleate Projects</span>
          </div>
        </div> */}
      </div>
