      ...
      <div className="md:text-center mb-8">
        ...
        >
          <p className="text-base sm:text-lg">
            We’re a team of creative digital marketers, designers, and
            strategists helping brands grow and thrive online.
          </p>
        </motion.div>
      </div>
          ...
          <div className="flex-1 w-full text-left md:text-left mb-8 md:mb-0">
            ...
            >
              ...
              <p className="text-justify sm:text-lg mb-5">
                ...
                complete solutions that make your brand stand out in a crowded
                market.
              </p>
            </motion.div>
